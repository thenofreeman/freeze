...
void Texture::draw(SDL_Renderer*& renderer, const Rect& clipping) const
{ 
    SDL_Rect quad = { 
        position.x, 
        position.y, 
...
void Texture::setPosition(Coor2<int> newPosition)
{ 
    position = newPosition;
}

void Texture::setDimensions(Dim2<int> newDimensions)
{ 
